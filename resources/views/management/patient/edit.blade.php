                            ...
                            <div class="col-lg-12">
                                <div class="row">
                                    ...
                                    <div class="col-lg-2 col-xs-12 mb-5">
                                        ...
                                        <input type="text" class="form-control @error('inisial_name') validate-has-error @enderror" id="inisial_name" name="inisial_name" value="{{ old('inisial_name', $detail->inisial_name) }}">
                                        @error('inisial_name')
                                            <span id="name-error" class="validate-has-error">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    <div class="col-lg-2 col-xs-12 mb-5">
                                        ...
                                        <input type="text" class="form-control @error('alias_name') validate-has-error @enderror" id="alias_name" name="alias_name" value="{{ old('alias_name', $detail->alias_name) }}">
                                        @error('alias_name')
                                            <span id="name-error" class="validate-has-error">{{ $message }}</span>
                                        @enderror
                                    </div>
                                        ...
                                        <select id="blood_type" name="blood_type" class="select2 @error('blood_type') validate-has-error @enderror" data-allow-clear="true" data-placeholder="Pilih Golongan Darah">
                                            ...
                                            @if ($blood_types)
                                                @foreach ($blood_types as $item)
                                                    <option value="{{ $item->id }}" @if(old('blood_type', $detail->blood_type_id) == $item->id) selected @endif>{{ $item->name }}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                        @error('blood_type')
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="row">
                                        ...
                                        <select id="district" name="district" class="select2 @error('district') validate-has-error @enderror" data-allow-clear="true" data-placeholder="Pilih Kecamatan">
                                            ...
                                            @if ($districts)
                                                @foreach ($districts as $item)
                                                    <option value="{{ $item->id }}" @if(old('district', $detail->district_id) == $item->id) selected @endif>{{ $item->name }}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                        @error('district')
                                    ...
                                    <div class="col-lg-2 col-xs-12 mb-5">
                                        ...
                                        <input type="text" class="form-control @error('ward') validate-has-error @enderror" id="ward" name="ward" value="{{ old('ward', $detail->ward) }}">
                                        @error('ward')
                                            <span id="name-error" class="validate-has-error">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    <div class="col-lg-2 col-xs-12 mb-5">
                                        ...
                                        <input type="text" class="form-control @error('post_code') validate-has-error @enderror" id="post_code" name="post_code" value="{{ old('post_code', $detail->post_code) }}">
                                        @error('post_code')
                                            <span id="name-error" class="validate-has-error">{{ $message }}</span>
                                        @enderror
                                    </div>
                            ...
                            <div class="col-lg-12">
                                <div class="row">
                                    <div class="col-lg-3 col-xs-12 mb-5">
                                        ...
                                        <input type="text" class="form-control @error('rm_no') validate-has-error @enderror" id="rm_no" name="rm_no" value="{{ old('rm_no', $detail->rm_no) }}">
                                        @error('rm_no')
                                            <span id="name-error" class="validate-has-error">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    <div class="col-lg-3 col-xs-12 mb-5">
                                        ...
                                        <input type="text" class="form-control @error('registration_no') validate-has-error @enderror" id="registration_no" name="registration_no" value="{{ old('registration_no', $detail->registration_no) }}">
                                    ...
                                    <div class="col-lg-3 col-xs-12 mb-5">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control datepicker @error('registration_date') validate-has-error @enderror" id="registration_date" name="registration_date" value="{{ old('registration_date', date('m/d/Y', strtotime($detail->registration_date))) }}">
                                            <div class="input-group-addon">
                                                <a href="#"><i class="entypo-calendar"></i></a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-3 col-xs-12 mb-5">
                                        ...
                                        <input type="text" class="form-control @error('doctor_reference') validate-has-error @enderror" id="doctor_reference" name="doctor_reference" value="{{ old('doctor_reference', $detail->doctor_reference) }}">
                                        ...
                                        <select id="action" name="action" class="select2 @error('action') validate-has-error @enderror" data-allow-clear="true" data-placeholder="Pilih Tindakan">
                                            ...
                                            @if ($actions)
                                                @foreach ($actions as $item)
                                                    <option value="{{ $item->id }}" @if(old('action', $detail->action_id) == $item->id) selected @endif>{{ $item->name }}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                        @error('action')
                                        ...
                                        <select id="assurance" name="assurance" class="select2 @error('assurance') validate-has-error @enderror" data-allow-clear="true" data-placeholder="Pilih Jaminan">
                                            ...
                                            @if ($assurances)
                                                @foreach ($assurances as $item)
                                                    <option value="{{ $item->id }}" @if(old('assurance', $detail->assurance_id) == $item->id) selected @endif>{{ $item->name }}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                        @error('assurance')
                                        ...
                                        <select id="clinic" name="clinic" class="select2 @error('clinic') validate-has-error @enderror" data-allow-clear="true" data-placeholder="Pilih Klinik">
                                            ...
                                            @if ($clinics)
                                                @foreach ($clinics as $item)
                                                    <option value="{{ $item->id }}" @if(old('clinic', $detail->clinic_id) == $item->id) selected @endif>{{ $item->name }}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                        @error('clinic')
                                        ...
                                        <select id="doctor" name="doctor" class="select2 @error('doctor') validate-has-error @enderror" data-allow-clear="true" data-placeholder="Pilih Dokter">
                                            ...
                                            @if ($doctors)
                                                @foreach ($doctors as $item)
                                                    <option value="{{ $item->id }}" @if(old('doctor', $detail->doctor_id) == $item->id) selected @endif>{{ $item->name }}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                        @error('doctor')
                                        ...
                                        <select id="hospital" name="hospital" class="select2 @error('hospital') validate-has-error @enderror" data-allow-clear="true" data-placeholder="Pilih Rumah Sakit">
                                            ...
                                            @if ($hospitals)
                                                @foreach ($hospitals as $item)
                                                    <option value="{{ $item->id }}" @if(old('hospital', $detail->hospital_id) == $item->id) selected @endif>{{ $item->name }}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                        @error('hospital')
                                        ...
                                        <select id="payment_method" name="payment_method" class="select2 @error('payment_method') validate-has-error @enderror" data-allow-clear="true" data-placeholder="Pilih Metode Pembayaran">
                                            ...
                                            @if ($payment_methods)
                                                @foreach ($payment_methods as $item)
                                                    <option value="{{ $item->id }}" @if(old('payment_method', $detail->payment_method_id) == $item->id) selected @endif>{{ $item->name }}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                ...
                                <div class="row">
                                        ...
                                        <select id="unit" name="unit" class="select2 @error('unit') validate-has-error @enderror" data-allow-clear="true" data-placeholder="Pilih Unit">
                                            ...
                                            @if ($units)
                                                @foreach ($units as $item)
                                                    <option value="{{ $item->id }}" @if(old('unit', $detail->unit_id) == $item->id) selected @endif>{{ $item->name }}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                        @error('unit')
                                        ...
                                        <select id="visit_method" name="visit_method" class="select2 @error('visit_method') validate-has-error @enderror" data-allow-clear="true" data-placeholder="Pilih Cara Kunjung">
                                            ...
                                            @if ($visit_methods)
                                                @foreach ($visit_methods as $item)
                                                    <option value="{{ $item->id }}" @if(old('visit_method', $detail->visit_method_id) == $item->id) selected @endif>{{ $item->name }}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                        @error('visit_method')
                                    ...
                                    <div class="col-lg-4 col-xs-12 mb-5">
                                        ...
                                        <select id="visit_time" name="visit_time" class="select2 @error('visit_time', $detail->visit_time_id) validate-has-error @enderror" data-allow-clear="true" data-placeholder="Pilih Waktu Kunjung">
                                            <option></option>
                                            @if ($visit_times)
                            ...
                            <div class="col-lg-12">
                                <div class="row">
                                    <div class="col-lg-6 col-xs-12 mb-5">
                                        ...
                                        <input type="text" class="form-control @error('allergy') validate-has-error @enderror" id="allergy" name="allergy" value="{{ old('allergy', $detail->allergy) }}">
                                        @error('allergy')
                                            <span id="name-error" class="validate-has-error">{{ $message }}</span>
                                        @enderror
                                    </div>
                                        ...
                                        <select id="marital_status" name="marital_status" class="select2 @error('marital_status') validate-has-error @enderror" data-allow-clear="true" data-placeholder="Pilih Status Kawin">
                                            ...
                                            @if ($marital_statuss)
                                                @foreach ($marital_statuss as $item)
                                                    <option value="{{ $item->id }}" @if(old('marital_status', $detail->marital_status_id) == $item->id) selected @endif>{{ $item->name }}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                        ...
                                        <select id="citizen" name="citizen" class="select2 @error('citizen') validate-has-error @enderror" data-allow-clear="true" data-placeholder="Pilih Kewarganegaraan">
                                            ...
                                            @if ($citizens)
                                                @foreach ($citizens as $item)
                                                    <option value="{{ $item->id }}" @if(old('citizen', $detail->citizen_id) == $item->id) selected @endif>{{ $item->name }}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                        @error('citizen')
                                        ...
                                        <select id="occupation" name="occupation" class="select2 @error('occupation') validate-has-error @enderror" data-allow-clear="true" data-placeholder="Pilih Kewarganegaraan">
                                            ...
                                            @if ($occupations)
                                                @foreach ($occupations as $item)
                                                    <option value="{{ $item->id }}" @if(old('occupation', $detail->occupation_id) == $item->id) selected @endif>{{ $item->name }}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                        @error('occupation')
